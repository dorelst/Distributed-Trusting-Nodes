...
public class SecondTrustingNode extends UnicastRemoteObject implements TrustingNodes, Serializable {
    ...
    private SecondTrustingNode() throws RemoteException {
        super();
        ...
        this.typesOfTrustSupportedByNode.put(1, "Differential Trust - B");
        this.typesOfTrustSupportedByNode.put(2, "Optimistic Trust - B");
        this.typesOfTrustSupportedByNode.put(3, "Pessimistic Trust - B");
    }
    ...
    private int differentialTrust(String dataEntryToBeProcessed) {
        System.out.print("Second Trust Node: Differential Trust: ");
    ...
    private int pessimisticTrust() {
        Random rand = new Random();
        System.out.println("Second Trust Node: Pessimistic Trust");
    ...
    public static void main(String[] args) {
        ...
        SecondTrustingNode secondTrustingNode=null;

        try {
            System.out.println("Creating Second Trusting Node Server!");
            String name = "SecondTrustingNode";
            secondTrustingNode = new SecondTrustingNode();
